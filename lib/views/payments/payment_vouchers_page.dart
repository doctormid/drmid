import 'package:drmid/entity/voucher.dart';
...
class _PaymentVouchersPageState extends State<PaymentVouchersPage>
    with SingleTickerProviderStateMixin {
  final PageController _controller = PageController();
  late TabController _tabController;

  List<Voucher> vouchers = [
    Voucher('tarjete de debito/credito', 130.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Finalizado'),
    Voucher('tarjete de debito/credito', 410.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Cancelado'),
    Voucher('tarjete de debito/credito', 150.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Finalizado'),
    Voucher('tarjete de debito/credito', 2310.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Cancelado'),
    Voucher('tarjete de debito/credito', 1000.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Cancelado'),
    Voucher('tarjete de debito/credito', 4540.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Finalizado'),
    Voucher('tarjete de debito/credito', 3430.0, '2021-03-17 11:25:23', 'Consultation',
        'MEXICALI, BAJA, CALIFORNIA', 'Finalizado'),
  ];
