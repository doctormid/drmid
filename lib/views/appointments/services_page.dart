...
import 'package:drmid/views/appointments/appointment_detail_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            appBar(AppLocalizations.of(context)!.services.toCapitalize(), context,
                hasBackBtn: true),
            Expanded(
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 5),
                                Text(AppLocalizations.of(context)!.consultationLong,
                                    style: hintStyle),
                                const SizedBox(height: 5),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 5),
                                Text('\$3000 M.X.N',
                                    style: hintStyle, textDirection: TextDirection.ltr),
                                const SizedBox(height: 5),
                                Text('\$3000 M.X.N',
                                    style: hintStyle, textDirection: TextDirection.ltr)
                              ],
                      ...
                      Row(
                        children: [
                          Text(AppLocalizations.of(context)!.advanceNotApplied,
                              style: mainStyle),
                          const Spacer(),
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (ctx) => const AppointmentDetailPage(true)),
                        );
                      },
                      padding: EdgeInsets.zero,
                      highlightColor: const Color(0xffE8ECFB),
