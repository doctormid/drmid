                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (_) {},
                                items:
                                    spinValues.map<DropdownMenuItem<String>>((String value) {
                        ...
                        const SizedBox(width: 16),
                        Container(
                            height: 30, width: double.infinity, color: ResColors.dividerColor),
                        Text(AppLocalizations.of(context)!.additionalInformation,
                                style: mainStyle)
