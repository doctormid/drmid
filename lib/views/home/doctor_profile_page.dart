...
import 'package:drmid/views/home/service_details_page.dart';
...
class _DoctorProfilePageState extends State<DoctorProfilePage> {
                      ...
                      children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(AppLocalizations.of(context)!.neurologist,
                                            style: hintStyle),
                                        const Spacer(),
                                        Text(AppLocalizations.of(context)!.consultation,
                                            style: hintStyle),
                          ...
                          child: ClipRRect(
                            ...
                            child: GoogleMap(
                              ...
                              initialCameraPosition:
                                  const CameraPosition(target: LatLng(39.9560861, -3.5033035)),
                        ...
                        ConstrainedBox(
                          constraints: BoxConstraints(
                              maxHeight: screenWidth(context, dividedBy: 10),
                        ...
                        ConstrainedBox(
                          constraints:
                              BoxConstraints(maxHeight: screenWidth(context, dividedBy: 4)),
                          child: Row(
                            children: [
                              ClipOval(
                                child: Image.asset('images/client.jpeg',
                              ...
                              Expanded(
                                ...
                                children: [
                                  ...
                                  const Spacer(),
                                  Text(AppLocalizations.of(context)!.veryGoodDoctor,
                                      style: hintStyle),
                                  const SizedBox(height: 15),
                                ],
                              )),
  ...
  Widget weekDay(context, String title) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: ResColors.primaryColor, borderRadius: BorderRadius.circular(size / 2)),
