...
import 'package:drmid/views/profile/edit_profile_page.dart';
import 'package:drmid/views/profile/profile_survey_page.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                        ...
                        child: Text('albertogakupo@gmail.com', style: mainStyle)),
                      ...
                      child: MaterialButton(
                        onPressed: () {
                          Navigator.of(context).push(
                              MaterialPageRoute(builder: (ctx) => const ProfileSurveyPage()));
                        },
                        elevation: 0,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                        child: Text(
