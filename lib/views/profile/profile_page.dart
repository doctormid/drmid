...
import 'package:drmid/views/profile/invite_friend_page.dart';
import 'package:drmid/views/profile/profile_detail_page.dart';
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        ConstrainedBox(
                          constraints:
                              BoxConstraints(maxHeight: screenWidth(context, dividedBy: 5)),
                          child: Row(
                            children: [
                              ClipOval(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text('Alberto Ramirez Sanchez', style: titleStyle)
                                      .viewPadding(left: 12),
                                  MaterialButton(
                                    onPressed: () {
                        ...
                        Divider(color: ResColors.dividerColor, height: 1),
                        menuItem(AppLocalizations.of(context)!.inviteFriend, 'addFriend',
                            onClick: () {
                          Navigator.of(context).push(
                              MaterialPageRoute(builder: (ctx) => const InviteFriendPage()));
                        }),
                        Divider(color: ResColors.dividerColor, height: 1),
                        const SizedBox(height: 15),
