...
class SizeConfig {
  ...
  static double unitHeightValue = 0;
  ...
  static double getFont(double size) {
    if (isTablet()) return size + safeBlockHorizontal;
    return size;
  }
  ...
  static double getHeight(double inputHeight) {
    if (isTablet()) return inputHeight + (safeBlockVertical * 2);

    return inputHeight;
  }

  static double getWidth(double inputWidth) {
    if (isTablet()) return inputWidth + (safeBlockHorizontal * 4);

    return inputWidth;
  }

  static double getMargin(double inputMargin) {
    if (isTablet()) return inputMargin + (safeBlockHorizontal);
