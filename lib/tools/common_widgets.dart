...
Widget appBar(String title, context, {bool hasBackBtn = false}) => Row(
      ...
      children: [
        ...
        MaterialButton(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
          child: SvgPicture.asset('images/messages.svg',
              color: Colors.white, width: 20, height: 20),
        ),
        const SizedBox(width: 5),
        MaterialButton(
          ...
          materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
          child:
              SvgPicture.asset('images/bell.svg', color: Colors.white, width: 20, height: 20),
        ),
        const SizedBox(width: 5),
        Expanded(
            child:
                Center(child: Text(title, style: titleStyle.copyWith(color: Colors.white)))),
        const SizedBox(width: 5),
        if (hasBackBtn)
          MaterialButton(
            onPressed: () {
