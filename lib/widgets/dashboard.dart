    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            const Header(),
            WidgetFactory.getDefaultSizedBox(),
            //myAppointments(context),
            //WidgetFactory.getDefaultSizedBox(),
            //recommendedForMe(context),
            //WidgetFactory.getDefaultSizedBox(),
            //scheduleAgain(context),
            WidgetFactory.getDefaultSizedBox(),
            Container(
              width: UiHelper.widthOrDefault(context, width: 80),
              height: 260,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: UiHelper.header('My appointments', context),
                  ),
                  Container(
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.only(left: 20.0, top: 20),
                    child: UiHelper.header('Messages', context),
                  ),
                  myAppointments(context)
                ],
              ),
            ...
            Column(
              children: [
                UiHelper.header('Specialties', context),
                speciatiesWidget(context),
              ],
            ),
            WidgetFactory.getDefaultSizedBox(),
          ],
